...
export default function AnalyticsDashboard() {
  ...
  return (
    <div className="container py-8">
      ...
      {/* --- ASSETVAULT BUSINESS METRICS --- */}
      <h2 className="text-2xl font-bold text-white mb-6 font-outfit animate-fade-in stagger-3" style={{ animationDelay: '0.4s' }}>Platform Metrics</h2>
      
      {/* KPIs */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 animate-fade-in stagger-3" style={{ animationDelay: '0.5s' }}>
        <div className="card glass-panel">
      ...
      {/* Charts Section */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8 animate-fade-in stagger-3" style={{ animationDelay: '0.6s' }}>
